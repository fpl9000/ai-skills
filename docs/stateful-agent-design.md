...
- [Stateful Agent System: Future Enhancements](stateful-agent-design-future.md) — future enhancements.
...
Planned upgrades that are deliberately deferred from the initial implementation are described in *[Stateful Agent Design: Future Enhancements](stateful-agent-design-future.md)*. Each addresses a limitation in this design.
